...
public class DistanceTest {
	...
	public static void main(String[] args){
		...
		System.out.println("Testing JSR-179 in leJOS");
		System.out.println("Coordinates.java");
		System.out.println("");
	...
	private static void credits(){
		System.out.println("");
		System.out.println("LEGO Mindstorms");
		System.out.println("NXT Robots  ");
		System.out.println("run better with");
		System.out.println("Java leJOS");
		System.out.println("");
		System.out.println("www.lejos.org");
